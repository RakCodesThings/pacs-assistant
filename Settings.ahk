...
class Settings {
    ...
    static ShowDialog() {
        ...
        settingsGui.Add("Button", "x+5 w60", "Browse").OnEvent("Click", (*) => this.BrowseSound(customSoundEdit))
        ...
        y += 190
        settingsGui.Add("Button", "x70 y" y " w80", "Save").OnEvent("Click", (*) => this.SaveSettings(checkboxes, refreshIntervalEdit, soundDropDown, customSoundEdit, settingsGui))
