...
class Settings {
    ...
    static ShowDialog() {
        ...
        testButton := settingsGui.Add("Button", "x" margin+10 " y+10 w60", "Test")
        testButton.OnEvent("Click", (*) => this.TestSound(soundDropDown.Text, customSoundEdit.Text))
        
        ; Get position after all notification controls for proper groupbox height
        testPos := testButton.GetPos()
        notificationsHeight := (testPos.y + testPos.h + 10) - notificationsY  ; Add 10px padding at bottom
        
        ; Now add the notifications groupbox with proper height
        ...
        y := testPos.y + testPos.h + 20  ; 20px spacing after Test button
