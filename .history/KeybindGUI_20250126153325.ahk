...
class KeybindGUI {
    ...
    StartListening(control, funcName, *) {
        ...
        ih.KeyOpt("{All}", "E")
        ih.OnEnd := this.OnInputEnd.Bind(this, funcName, control, ih)
        ih.Start()
    }

    OnInputEnd(funcName, control, ih, promptGui := 0) {
    ...
    PromptKeybind(funcName, listView) {
        ...
        ih := InputHook("V B")
        ih.KeyOpt("{All}", "E")
        ih.OnEnd := this.OnInputEnd.Bind(this, funcName, listView, ih, promptGui)
        ih.Start()
