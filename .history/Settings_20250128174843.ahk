...
class Settings {
    ...
    static ShowDialog() {
        ...
        settingsGui.Add("Button", "x" margin+10 " y+5 w60", "Test").OnEvent("Click", (*) => this.TestSound(soundDropDown.Text, customSoundEdit.Text))
        ...
        ; Add bottom margin
        y += buttonWidth
        settingsGui.Add("Text", "x" margin " y" y+margin " w0 h0")  ; Invisible control to enforce bottom margin
