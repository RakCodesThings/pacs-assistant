...
class KeybindGUI {
    ...
    ApplyBinds() {
        ...
        for funcName, bind in profiles[currentProfile] {
            try {
                ...
                Hotkey(bind, (*) => KeybindGUI.functionMap[funcName]())  ; Use a lambda to call the function
    ...
    static functionMap := Map(
        "toggleDictation", KeybindGUI.toggleDictation,
        "testFunction", KeybindGUI.testFunction
    )
}
