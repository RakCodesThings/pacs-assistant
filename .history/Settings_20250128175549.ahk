...
class Settings {
    ...
    static ShowDialog() {
        ...
        y += 110
        notificationsY := y  ; Store starting Y position of notifications section
        
        ; Calculate height for notifications section based on its contents:
        ; - 2 checkboxes (25px each + 10px spacing)
        ; - Alert Sound label + dropdown (25px + 5px spacing)
        ; - Custom Sound label + edit + browse (25px + 5px spacing)
        ; - Test button (25px)
        ; - 20px padding at top and bottom
        notificationsHeight := 200  ; Total height needed for all controls plus padding
        ...
        settingsGui.Add("Button", "x" margin+10 " y+10 w60", "Test")
        ...
        y := notificationsY + notificationsHeight + 20  ; 20px spacing after notifications section
