...
#Include pacs-assistant.ahk  ; Add include statement at the top
...
hotkeyFunctions["toggleDictation"] := ToggleDictation  ; Use the proper case of the function name
...
class KeybindGUI {
    ...
    ApplyBinds() {
        ...
        for funcName, bind in profiles[currentProfile] {
            try {
                Hotkey(bind, hotkeyFunctions[funcName])
